...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 150, 721, 323))
        ...
        self.listView_dids.setEnabled(False)
        self.listView_dids.setGeometry(QtCore.QRect(565, 60, 141, 231))
        self.listView_dids.setObjectName("listView_dids")
        self.pushButton_cleartrace = QtWidgets.QPushButton(self.CANUDS)
        self.pushButton_cleartrace.setGeometry(QtCore.QRect(0, 70, 41, 23))
        self.pushButton_cleartrace.setObjectName("pushButton_cleartrace")
        self.tabWidget.addTab(self.CANUDS, "")
        self.CANFlash = QtWidgets.QWidget()
        self.CANFlash.setObjectName("CANFlash")
        self.checkBox_flashcanfd = QtWidgets.QCheckBox(self.CANFlash)
        self.checkBox_flashcanfd.setEnabled(True)
        self.checkBox_flashcanfd.setGeometry(QtCore.QRect(10, 10, 68, 23))
        self.checkBox_flashcanfd.setObjectName("checkBox_flashcanfd")
        self.pushButton_flash = QtWidgets.QPushButton(self.CANFlash)
        self.pushButton_flash.setEnabled(False)
        self.pushButton_flash.setGeometry(QtCore.QRect(10, 130, 51, 23))
        self.pushButton_flash.setObjectName("pushButton_flash")
        self.progressBar = QtWidgets.QProgressBar(self.CANFlash)
        self.progressBar.setEnabled(False)
        self.progressBar.setGeometry(QtCore.QRect(10, 270, 691, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.textBrowser_flashinfo = QtWidgets.QTextBrowser(self.CANFlash)
        self.textBrowser_flashinfo.setGeometry(QtCore.QRect(70, 130, 631, 131))
        self.textBrowser_flashinfo.setObjectName("textBrowser_flashinfo")
        self.pushButton_clearflashinfo = QtWidgets.QPushButton(self.CANFlash)
        self.pushButton_clearflashinfo.setGeometry(QtCore.QRect(10, 170, 51, 23))
        self.pushButton_clearflashinfo.setObjectName("pushButton_clearflashinfo")
        self.groupBox_app = QtWidgets.QGroupBox(self.CANFlash)
        self.groupBox_app.setGeometry(QtCore.QRect(360, 30, 340, 91))
        self.groupBox_app.setObjectName("groupBox_app")
        self.toolButton_loadapp = QtWidgets.QToolButton(self.groupBox_app)
        self.toolButton_loadapp.setGeometry(QtCore.QRect(310, 20, 21, 18))
        self.toolButton_loadapp.setPopupMode(QtWidgets.QToolButton.DelayedPopup)
        self.toolButton_loadapp.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)
        self.toolButton_loadapp.setObjectName("toolButton_loadapp")
        self.lineEdit_apppath = QtWidgets.QLineEdit(self.groupBox_app)
        self.lineEdit_apppath.setGeometry(QtCore.QRect(0, 20, 300, 20))
        self.lineEdit_apppath.setReadOnly(True)
        self.lineEdit_apppath.setObjectName("lineEdit_apppath")
        self.label_3 = QtWidgets.QLabel(self.groupBox_app)
        self.label_3.setGeometry(QtCore.QRect(140, 50, 121, 31))
        palette = QtGui.QPalette()
        ...
        self.groupBox_drive = QtWidgets.QGroupBox(self.CANFlash)
        self.groupBox_drive.setGeometry(QtCore.QRect(10, 30, 340, 91))
        self.groupBox_drive.setObjectName("groupBox_drive")
        self.toolButton_loaddrive = QtWidgets.QToolButton(self.groupBox_drive)
        self.toolButton_loaddrive.setGeometry(QtCore.QRect(310, 20, 21, 18))
        self.toolButton_loaddrive.setPopupMode(QtWidgets.QToolButton.DelayedPopup)
        self.toolButton_loaddrive.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)
        self.toolButton_loaddrive.setObjectName("toolButton_loaddrive")
        self.lineEdit_drivepath = QtWidgets.QLineEdit(self.groupBox_drive)
        self.lineEdit_drivepath.setGeometry(QtCore.QRect(0, 20, 300, 20))
        self.lineEdit_drivepath.setReadOnly(True)
        self.lineEdit_drivepath.setObjectName("lineEdit_drivepath")
        self.label_2 = QtWidgets.QLabel(self.groupBox_drive)
        self.label_2.setGeometry(QtCore.QRect(70, 50, 121, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(214, 214, 214))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.comboBox_flashconfig = QtWidgets.QComboBox(self.CANFlash)
        self.comboBox_flashconfig.setGeometry(QtCore.QRect(180, 0, 151, 22))
        self.comboBox_flashconfig.setObjectName("comboBox_flashconfig")
        self.label_flashconfig = QtWidgets.QLabel(self.CANFlash)
        self.label_flashconfig.setGeometry(QtCore.QRect(100, 0, 81, 29))
        self.label_flashconfig.setObjectName("label_flashconfig")
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(310, 40, 121, 22))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(310, 70, 121, 22))
        ...
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(310, 100, 121, 22))
        ...
        self.actionECU_config = QtWidgets.QAction(MainWindow)
        self.actionECU_config.setObjectName("actionECU_config")
        self.actionDLL_Folder = QtWidgets.QAction(MainWindow)
        self.actionDLL_Folder.setObjectName("actionDLL_Folder")
        self.action_about = QtWidgets.QAction(MainWindow)
        self.action_about.setObjectName("action_about")
        self.menu.addAction(self.actionECU_config)
        self.menu.addAction(self.actionDLL_Folder)
        ...
        self.pushButton_cleartrace.clicked.connect(self.textEdit_trace.clear) # type: ignore
        self.pushButton_clearflashinfo.clicked.connect(self.textBrowser_flashinfo.clear) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_cleartrace.setText(_translate("MainWindow", "Clear"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.CANUDS), _translate("MainWindow", "CAN UDS"))
        self.checkBox_flashcanfd.setText(_translate("MainWindow", "CANFD"))
        self.pushButton_flash.setText(_translate("MainWindow", "Flash"))
        self.pushButton_clearflashinfo.setText(_translate("MainWindow", "Clear"))
        self.groupBox_app.setTitle(_translate("MainWindow", "AppFlie"))
        self.toolButton_loadapp.setText(_translate("MainWindow", "..."))
        self.label_3.setText(_translate("MainWindow", "拖入选择文件"))
        self.groupBox_drive.setTitle(_translate("MainWindow", "DriveFlie"))
        self.toolButton_loaddrive.setText(_translate("MainWindow", "..."))
        self.label_2.setText(_translate("MainWindow", "拖入选择文件"))
        self.label_flashconfig.setText(_translate("MainWindow", "FlashConfig:"))
        ...
        self.menu.setTitle(_translate("MainWindow", "Flie"))
        self.menu_2.setTitle(_translate("MainWindow", "Help"))
        self.actionECU_config.setText(_translate("MainWindow", "ECU Config"))
        self.actionDLL_Folder.setText(_translate("MainWindow", "DLL Folder"))
